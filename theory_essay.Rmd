...
As stated above, Gloger's rule stems from his observations of bird plumage darkness across climatic moisture gradients (and, by the simplest extension, pigementation in endothermic animals too) Gloger noted bird plumage was darker in warmer, more humidi areas [@Miksch2015; @burtt2004]. @Roulin2015 describe the logic of Gloger’s rule lucidly:
...
<!--His contemporaries' thoughts--> Gloger's rule has garnered research interest and support over the years<!--is this true? ref!-->.<!--Expand on the rule's study through history (i.e. since 1833)--> Like many other other ecogeographic rules, Gloger's rule has gained renewed research interest in the last 10<!--??--> years<!--ref!!!!!!! Which one was it???-->.
