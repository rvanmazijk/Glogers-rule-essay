...
<!--
restructuring possible? what about (= structure1):
    - Intro
    - Ecogeographic rules
    - Evidence & mechanisms
        - intraspecific level
...
or (= structure2) (= this branch):
    ...
    - Evidence & mechanisms
        ...
        - [''] * [levels]
    - Concl
aot the current layout, which is (= structure0):
    - Intro
    - Ecogeographic rules
    - Evidence
        - [taxa] * [levels]
...
<!--
structure thought: a table?:
Table 1. [...]
                                            Taxon
                    ----------------------------------------------------------------
                    |  Endothermic animals   |  Ectothermic animals   |   Plants   |
      --------------|------------------------|------------------------|-------------
      | intrasp.    |                        |                        |            |
Scale | intersp.    |                        |                        |            |
      | assemblage  |                        |                        |            |
