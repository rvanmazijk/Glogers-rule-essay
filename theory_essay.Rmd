...
\par \noindent \textbf{R. van Mazijk} \footnotesize <VMZRUA001@myuct.ac.za>
...
- Eco-geographic and biogeographic rules
    - Biological/biogeographic "rules": Lomolino et al. 2006; Gaston et al. 2008 (has a def for Gloger's rule too) (also d/d's betw intrasp. traits, intersp. traits, and assemblage patterns (in community properties or community trait avgs))
...
- ...
- Burtt & Ichida -> dark pulamge resistant to bacterial degradation (~ pgiments), a common problem in humid climes; mthods: measure intrasp. ∆colour vs bacterial activity
