...
\begin{wrapfigure}{l}{15pt}
    \includegraphics[width=1.25cm, height=1.25cm]{uct logo copy.png} \par
    \includegraphics[width=1.25cm, height=1.25cm]{bio sci logo crop.png}
\end{wrapfigure}
...
- Gloger vs anti-Gloger patterns (Lev-Yadun 2015)
    - e.g "negative Gloger's rule" in invertebrates, e.g. Collembolates [@Rapoport1969]
